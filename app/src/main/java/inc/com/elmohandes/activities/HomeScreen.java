...
public class HomeScreen extends AppCompatActivity
    ...
    ImageView inspiration, allColors, recolor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        allColors.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), ColorCategoryActivity.class);
                startActivity(intent);
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        else if (id == R.id.allColors)
        {
            Intent intent = new Intent(getApplicationContext() , AllColorsActivity.class);
            startActivity(intent);
        }
